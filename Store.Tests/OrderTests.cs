...
namespace Store.Tests
{
    public class OrderTests
    {
        ...
        [Fact]
        public void AddItem_WithoutBooks_ThrowsArgumentNullException()
        {
            var order = new Order(1, new[]
            {
                new OrderItem(1, 3, 10m),
        ...
        [Fact]
        public void AddOrUpdateItem_WithNotExistingItem_AddsCount()
        {
            var order = new Order(1, new[]
            {
                new OrderItem(1, 3, 10m),
        ...
        [Fact]
        public void AddOrUpdateItem_WithNullItem_ThrowsArgumentNullException()
        {
            var order = new Order(1, new[]
            {
                new OrderItem(1, 3, 10m),
        ...
        [Fact]
        public void RemoveItem_WithNotExistingItem_ThrowsInvalidOperationException()
        {
            var order = new Order(1, new[]
            {
                new OrderItem(1, 3, 10m),
