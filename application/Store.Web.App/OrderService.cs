...
namespace Store.Web.App
{
    public class OrderService
    {
        ...
        private readonly IHttpContextAccessor? httpContextAccsesor;

        protected ISession Session => httpContextAccsesor.HttpContext.Session;

        public OrderService(IBookRepository? bookRepository, IOrderRepository? orderRepository,
                            INotificationService? notificationService, IHttpContextAccessor? httpContextAccsesor)
        {
            this.bookRepository = bookRepository;
            this.orderRepository = orderRepository;
            this.notificationService = notificationService;
            this.httpContextAccsesor = httpContextAccsesor;
        }
        ...
        internal IEnumerable<Book> GetBook(Order order)
        {
        ...
        {
            if (count < 1)
                throw new InvalidOperationException("Too few books add.");
